...
public class AABB_tree_Segment_3_soup {
  ...
  public Optional_Object_and_Integer any_intersection(Plane_3 query) {
    return new Optional_Object_and_Integer(CGAL_AABB_treeJNI.AABB_tree_Segment_3_soup_any_intersection__SWIG_1(swigCPtr, this, Plane_3.getCPtr(query), query), true);
  }

  public Optional_Object_and_Integer any_intersection(Triangle_3 query) {
    return new Optional_Object_and_Integer(CGAL_AABB_treeJNI.AABB_tree_Segment_3_soup_any_intersection__SWIG_2(swigCPtr, this, Triangle_3.getCPtr(query), query), true);
  }
  ...
  public void all_intersections(Plane_3 query, Collection<Object_and_Integer> out) {
    CGAL_AABB_treeJNI.AABB_tree_Segment_3_soup_all_intersections__SWIG_1(swigCPtr, this, Plane_3.getCPtr(query), query, out);
  }

  public void all_intersections(Triangle_3 query, Collection<Object_and_Integer> out) {
    CGAL_AABB_treeJNI.AABB_tree_Segment_3_soup_all_intersections__SWIG_2(swigCPtr, this, Triangle_3.getCPtr(query), query, out);
  }
  ...
  public Point_and_Integer closest_point_and_primitive(Point_3 c1, Point_and_Integer c2) {
    return new Point_and_Integer(CGAL_AABB_treeJNI.AABB_tree_Segment_3_soup_closest_point_and_primitive__SWIG_1(swigCPtr, this, Point_3.getCPtr(c1), c1, Point_and_Integer.getCPtr(c2), c2), true);
  }

  public void closest_point_and_primitive(Point_3 c1, Point_and_Integer c2, Point_and_Integer ret) {
    CGAL_AABB_treeJNI.AABB_tree_Segment_3_soup_closest_point_and_primitive__SWIG_2(swigCPtr, this, Point_3.getCPtr(c1), c1, Point_and_Integer.getCPtr(c2), c2, Point_and_Integer.getCPtr(ret), ret);
  }
