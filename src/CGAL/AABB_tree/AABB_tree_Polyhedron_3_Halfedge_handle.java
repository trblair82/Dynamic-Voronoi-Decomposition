...
public class AABB_tree_Polyhedron_3_Halfedge_handle {
  ...
  public Optional_Object_and_Polyhedron_3_Halfedge_handle any_intersection(Plane_3 query) {
    return new Optional_Object_and_Polyhedron_3_Halfedge_handle(CGAL_AABB_treeJNI.AABB_tree_Polyhedron_3_Halfedge_handle_any_intersection__SWIG_1(swigCPtr, this, Plane_3.getCPtr(query), query), true);
  }

  public Optional_Object_and_Polyhedron_3_Halfedge_handle any_intersection(Triangle_3 query) {
    return new Optional_Object_and_Polyhedron_3_Halfedge_handle(CGAL_AABB_treeJNI.AABB_tree_Polyhedron_3_Halfedge_handle_any_intersection__SWIG_2(swigCPtr, this, Triangle_3.getCPtr(query), query), true);
  }
  ...
  public void all_intersections(Plane_3 query, Collection<Object_and_Polyhedron_3_Halfedge_handle> out) {
    CGAL_AABB_treeJNI.AABB_tree_Polyhedron_3_Halfedge_handle_all_intersections__SWIG_1(swigCPtr, this, Plane_3.getCPtr(query), query, out);
  }

  public void all_intersections(Triangle_3 query, Collection<Object_and_Polyhedron_3_Halfedge_handle> out) {
    CGAL_AABB_treeJNI.AABB_tree_Polyhedron_3_Halfedge_handle_all_intersections__SWIG_2(swigCPtr, this, Triangle_3.getCPtr(query), query, out);
  }
  ...
  public Point_and_Polyhedron_3_Halfedge_handle closest_point_and_primitive(Point_3 c1, Point_and_Polyhedron_3_Halfedge_handle c2) {
    return new Point_and_Polyhedron_3_Halfedge_handle(CGAL_AABB_treeJNI.AABB_tree_Polyhedron_3_Halfedge_handle_closest_point_and_primitive__SWIG_1(swigCPtr, this, Point_3.getCPtr(c1), c1, Point_and_Polyhedron_3_Halfedge_handle.getCPtr(c2), c2), true);
  }
  ...
  public void closest_point_and_primitive(Point_3 c1, Point_and_Polyhedron_3_Halfedge_handle c2, Point_and_Polyhedron_3_Halfedge_handle ret) {
    CGAL_AABB_treeJNI.AABB_tree_Polyhedron_3_Halfedge_handle_closest_point_and_primitive__SWIG_2(swigCPtr, this, Point_3.getCPtr(c1), c1, Point_and_Polyhedron_3_Halfedge_handle.getCPtr(c2), c2, Point_and_Polyhedron_3_Halfedge_handle.getCPtr(ret), ret);
  }
