...
public class Polyhedron_3 {
  ...
  public void delegate(Polyhedron_3_Modifier_base modifier) {
    CGAL_Polyhedron_3JNI.Polyhedron_3_delegate(swigCPtr, this, Polyhedron_3_Modifier_base.getCPtr(modifier), modifier);
  }

  public void write_to_file(String off_filename) {
    CGAL_Polyhedron_3JNI.Polyhedron_3_write_to_file(swigCPtr, this, off_filename);
  }
